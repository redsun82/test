...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "anyhow": Label("@vendor//:anyhow-1.0.96"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//crates:BUILD.anyhow-1.0.96.bazel"),
    )

    return [
        struct(repo = "vendor__anyhow-1.0.96", is_dev_dep = False),
    ]
